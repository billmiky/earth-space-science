...
.check-understanding {
  ...
  margin: 20px 0;
  border-radius: 12px;
  border: 1px solid #4eb8e8;
  border-left: 6px solid #4eb8e8;
  box-shadow: 0 2px 8px rgba(11, 61, 110, 0.1);
}
.check-understanding h3 { margin-top: 0; color: #0b3d6e; }
.check-understanding ol, .check-understanding li { color: inherit; }
</style>
```
...
This textbook is based on the **New Visions for Public Schools** Earth & Space Science curriculum. The majority of resources from [curriculum.newvisions.org](https://curriculum.newvisions.org) are Open Educational Resources (OER) available under the terms of the:
...
Materials created by New Visions' partners are subject to other licenses; copyright on those resources is retained by the original author(s). Partners have granted New Visions a license to publish these resources for use by affiliated schools and teachers, and are identified as the original publisher.

**Regents Examination Questions:** Used with permission from the **New York State Education Department**. Past Regents Examinations are available at [nysedregents.org](http://www.nysedregents.org/). The New York State Education Department retains all rights. Reproducing materials for profit or any commercial use is strictly forbidden without express prior written permission of the New York State Education Department. Any reproduction or distribution must expressly credit the New York State Education Department.
:::
