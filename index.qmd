...
.check-understanding {
  background: linear-gradient(to right, #1a3a5c, #0b3d6e);
  color: white !important;
  padding: 20px 24px;
  margin: 20px 0;
  border-radius: 12px;
  border-left: 6px solid #4eb8e8;
  box-shadow: 0 4px 16px rgba(11, 61, 110, 0.35);
}
.check-understanding * { color: white !important; }
.check-understanding h3 { margin-top: 0; color: #a8d8f0 !important; }
.check-understanding ol, .check-understanding li { color: white !important; }
</style>
```
