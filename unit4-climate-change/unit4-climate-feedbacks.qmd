...
<span class="pe-badge">HS-ESS2-2</span> <span class="pe-badge">HS-ESS2-4</span> <span class="pe-badge">HS-ESS2-6</span>
...
# Explain: Feedback Loops in the Climate System
...
1. **Arctic has lots of ice** (high albedo ~60%)
2. **Global warming melts some ice**
3. **Dark ocean exposed** (low albedo ~6%)
4. **Ocean absorbs 10x more energy** than ice did
5. **Local temperature rises dramatically**
6. **More ice melts** → cycle continues

This is why the Arctic is the "canary in the coal mine" for climate change!
:::
...
# Elaborate: CO₂ and Human Activity
