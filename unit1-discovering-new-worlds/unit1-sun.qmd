...
3. If an exoplanet's star showed a very different spectral pattern — say, mostly iron and carbon — what might that tell you about its ability to support life?
:::
...
5. If our Sun were twice as massive, it would burn through fuel **8× faster.** What would that mean for life?
:::
...
::: {.evaluate-box}
## ✏️ Revise Your Habitability Model
...
- ☀️ The Sun is **73% hydrogen** and **25% helium** — we know this from spectroscopy
- ⚛️ The Sun produces energy through **nuclear fusion** ($4H → He + energy$)
- ⏱️ Only fusion explains both the **quantity** and **duration** of solar energy
- 🌡️ The Sun has been stable for **4.6 billion years** — critical for life
- 🔮 The Sun will remain stable for **~5 more billion years** before becoming a red giant
:::
