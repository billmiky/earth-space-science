...
<div id="float-toc-btn" onclick="window.floatTocToggle()" role="button" aria-label="Toggle book navigation" title="Toggle book navigation">🌍</div>
<script>
(function(){
  window.floatTocToggle=function(){
    var b=document.getElementById('float-toc-btn');
    var sidebar=document.getElementById('quarto-sidebar');
    var toggle=document.querySelector('[data-bs-target=".quarto-sidebar-collapse-item"]');
    if(toggle){toggle.click();}
    b.classList.toggle('toc-open');
  };
})();
</script>
