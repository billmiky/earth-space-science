...
<a class="quiz-jump-btn" href="#moon-myths">🧠 Jump to Myths vs. Facts &amp; Quiz ↓</a>
...
## Interactive Simulation: Visualizing Spring and Neap Tides

```{=html}
<div style="margin: 28px 0;">
  <div style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border: 2px solid #334155; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.4);">
    <div style="background: #0f172a; border-bottom: 1px solid #1e293b; padding: 14px 20px; display: flex; align-items: center; gap: 12px;">
      <span style="font-size: 1.3rem; font-weight: 800; background: linear-gradient(to right, #38bdf8, #818cf8); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">🌊 Spring vs. Neap Tides Simulator</span>
    </div>
    <iframe
      src="spring-neap-simulation.html"
      width="100%"
      height="1000"
      style="display: block; border: none;"
      title="Spring and Neap Tides Interactive Simulation"
      loading="lazy"
    ></iframe>
  </div>
</div>
